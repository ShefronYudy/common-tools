...
public abstract class RSACoder extends Coder {
     ...
     * @throws Exception
     */
    public static String sina(byte[] data,String privateKey) throws Exception{
        //解密由base64编码的私钥
    ...
    public static byte[] decryptByPrivateKey(byte[] data,String key) throws Exception{
        //对密钥解密
        byte[] keyByptes = decodeByBase64(key);
        //取得私钥
        PKCS8EncodedKeySpec keySpec = new PKCS8EncodedKeySpec(keyByptes);
        KeyFactory keyFactory = KeyFactory.getInstance(KEY_ALGORITHM);
