...
public class XmlPrintWriter {
    ...
    private final char[] lineIndenter;//ÐÐ¼ä¾à
    ...
    public XmlPrintWriter(Writer writer, char[] lineIndenter, String newLine) {
        this.writer = new PrintWriter(writer);
        this.lineIndenter = lineIndenter;
        this.newLine = newLine;
    }

    public XmlPrintWriter(Writer writer, char[] lineIndenter) {
        this(writer, lineIndenter, "\n");
    }

    public XmlPrintWriter(Writer writer, String lineIndenter, String newLine) {
        this(writer, lineIndenter.toCharArray(), newLine);
    }

    public XmlPrintWriter(Writer writer, String lineIndenter) {
