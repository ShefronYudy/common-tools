...
public class ObjFactory {
	 ...
	 * @throws	Exception thrown if class name not found in class path, or does not
	...
	public static <T> T make(String className, String typeName) throws Exception {
		Object obj = null;
		String errMsg = null;
		try {
            ...
            try {
                ...
                // object configuration and a Exception will be thrown.
                if ( !Modifier.isStatic( singleton.getModifiers() ) )
                {
                    throw new Exception( "Class [" + className + "] contains a non-static getInstance method." );
                }
                ...
                // getInstance method on the class, thus this is a configuration issue and a Exception
                // is thrown
                throw new Exception( "The SecurityManager has restricted the object factory from getting a reference to the singleton implementation" +
