...
public class URIEncoderDecoder {
	...
	/**
	 * Other characters, which are Unicode chars that are not US-ASCII, and are
	 * not ISO Control or are not ISO Space chars are not preserved(保持,保存). They
	 * are converted into their hexidecimal value prepended by '%'.
	 * <p/>
	...
	public static void main(String[] ars) {
		try {
			System.out.println(URIEncoderDecoder.decode("%E2%82%AC"));
			System.out.println(URIEncoderDecoder
					.encodeOthers("www.boo.com?time=123&name=李云"));

			System.out.println(URIEncoderDecoder
					.decode("www.boo.com?time=123&name=%E6%9D%8E%E4%BA%91"));
