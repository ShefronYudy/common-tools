...
public class ReaderWriterLock {
	 ...
	 * @author Scott Oak and Henry Wong
	 */
	private final static class ReaderWriterNode {
	...
	/** The waiting threads. */
	private ArrayList<ReaderWriterNode> waiters;

	/**
	 * Default constructor.
	 */
	public ReaderWriterLock() {
		this.waiters = new ArrayList<ReaderWriterNode>();
	}
	...
	private int firstWriter() {
		final Iterator<ReaderWriterNode> e = this.waiters.iterator();
		int index = 0;
		while (e.hasNext()) {
