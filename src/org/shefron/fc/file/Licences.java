...
public class Licences {
	...
	/**
	 * Returns a reference to the single instance of this class. In fact, there
	 * is little point to having an instance of this class, but we're leaving it
	 * that way for backwards compatibility until the JCommon retirement.
	 * 
